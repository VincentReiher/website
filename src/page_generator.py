...
def generate_page(src_file, template_path, dest_folder):
...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for item_name in content_files:
        if os.path.isfile(dir_path_content + item_name):
            generate_page(dir_path_content + item_name, template_path, dest_dir_path)
        else:
            ...
            generate_pages_recursive(new_source_dir, template_path, new_target_dir)
